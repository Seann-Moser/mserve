module github.com/DarlingGoose/mserve

go 1.25.4

require (
	github.com/DarlingGoose/credentials v0.0.31
...
require (
	...
	github.com/youmark/pkcs8 v0.0.0-20240726163527-a2c0da244d78 // indirect; indirectprometheus
